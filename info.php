...
if (isset($_GET['url'])){
	...
	if (isset($re->formats)){
		...
		$isi = "<div style='width:90%;position: absolute'><div style='position: relative;float:left;max-width:65%;height:80vh'><video style='width:100%' src='$is' loop muted controls></video></div><div style='left:10px;position:relative'><a href='$wr'>$wr</a><ul>$si</ul></div></div>";
